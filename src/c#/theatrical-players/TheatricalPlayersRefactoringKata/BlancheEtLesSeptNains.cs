            ...
            Dictionary<string, Extension> Mystuff)
        {
            ...
            return n.Woohoo
                .Map(z =>
                {
                    ...
                    var amount = applySoldOut(CommonUtilsManagerFactoryHandler._p, z.Audience)
                        .Match(price => price, _ => throw new Exception($"unknown type: {CommonUtilsManagerFactoryHandler._p}"));

                    var credits = NotCrappyTreatment(CommonUtilsManagerFactoryHandler._p, z.Audience);
                    ...
                    {
                        return new Ss(
                            l(((IReadOnlyDictionary<string, Extension>)Mystuff)[z.PlayId].Name, amount, z.Audience),
                            amount,
                            credits);
                    }
                    else
